...
"""
Clone of Docker's namesgenerator.
...
# Docker, starting from 0.7.x, generates names from notable scientists
# and hackers.
surnames = (
...
def random_name():
    ...
    in this package formatted as 'adjective_surname'.
    For example 'focused_turing'.
    """
    while True:
        s = '_'.join(map(random.choice, [adjectives, surnames]))
        if s != 'boring_wozniak': # Steve Wozniak is not boring
            return s
